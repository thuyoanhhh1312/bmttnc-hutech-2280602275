...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(764, 570)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(260, 20, 281, 81))
        font = QtGui.QFont()
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(130, 120, 561, 87))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.txt_cipher_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(130, 290, 561, 87))
        ...
        self.txt_key.setGeometry(QtCore.QRect(130, 240, 561, 22))
        self.txt_key.setObjectName("txt_key")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(210, 420, 93, 28))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.btn_decrypt.setGeometry(QtCore.QRect(510, 420, 93, 28))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(10)
        font.setBold(True)
